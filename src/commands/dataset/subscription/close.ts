...
export default class DatasetSubscriptionClose extends Command {
  static override description = 'Close a data-source subscription task.';

  static override examples = [
    '<%= config.bin %> dataset subscription close --task-id task_xxx',
    '<%= config.bin %> dataset subscription close --data @subscription-close.json'
  ];
