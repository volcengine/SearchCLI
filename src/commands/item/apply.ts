...
export default class ItemApply extends Command {
  ...
  static override flags = {
    ...
    'recommend-parent-ids': Flags.string({
      description: 'Comma-separated parent item ids for runtime recommend smoke after recommend bootstrap.'
    }),
  ...
  async run(): Promise<void> {
    ...
    await runItemApplyCommand({
      ...
      recommendParentIds: splitCommaList(flags['recommend-parent-ids']),
