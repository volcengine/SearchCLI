# GetDatasetImageRetryTask

## Overview

- API name: `GetDatasetImageRetryTask`
- Category: Control Plane - Task
- Description: Gets Dataset Image Retry Task.

## IDL Definition

```proto
message GetDatasetImageRetryTaskReq {
  string DatasetId = 2;
  string ProjectName = 20;
}

message GetDatasetImageRetryTaskResp {
  string TaskId = 1;
  string Status = 2;
}
```
