...
| Field | Type | Required | Description |
| --- | --- | --- | --- |
| `Apps[]` | array<Application> | No | Apps. |
| `Apps[].AppID` | string | See service validation | Application ID. |
| `Apps[].Name` | string | See service validation | Name. |
| `Apps[].Type` | AppType | See service validation | Type. |
| `Apps[].State` | AppState | See service validation | State. |
| `Apps[].Description` | string | See service validation | Description. |
| `Apps[].CreatedAt` | int64 | See service validation | Created at. |
| `Apps[].UpdatedAt` | int64 | See service validation | Updated at. |
| `Apps[].UpdatedBy` | string | See service validation | Updated by. |
| `Apps[].Datasets[]` | array<Dataset> | No | Datasets. |
...
| `Apps[].Tool` | ApplicationTool | See service validation | Tool. |
| `Apps[].GeneratedDescription` | string | See service validation | Generated description. |
| `Apps[].Language` | string | See service validation | Language. |
| `Apps[].PostPaidType` | string | See service validation | Post paid type. |
| `Apps[].Tags[]` | array<Tag> | No | Tags. |
...
| `Apps[].Datasets[].DataNum` | int64 | See service validation | Data num. |
| `Apps[].Datasets[].Applications[]` | array<DatasetRefApp> | No | Applications. |
| `Apps[].Datasets[].Description` | string | See service validation | Description. |
| `Apps[].Datasets[].Schema[]` | array<DatasetSchemaField> | No | Schema. |
...
| `Apps[].Datasets[].UpdatedBy` | string | See service validation | Updated by. |
| `Apps[].Datasets[].DataFieldConfig` | DataFieldConfig | See service validation | Data field config. |
...
| `Apps[].Datasets[].PreProcessedDataNum` | int64 | See service validation | Pre processed data num. |
| `Apps[].Datasets[].Industry` | IndustryType | See service validation | Industry. |
| `Apps[].Datasets[].tag` | DatasetTag | See service validation | Tag. |
| `Apps[].Datasets[].DocumentStats` | DocumentStats | See service validation | Document stats. |
...
| `Apps[].Datasets[].MultiModalStats` | MultiModalStats | See service validation | Multi modal stats. |
...
| `Apps[].Tool.Name` | string | See service validation | Name. |
| `Apps[].Tool.Description` | string | See service validation | Description. |
| `Apps[].Tags[].Key` | string | See service validation | Key. |
| `Apps[].Tags[].Value` | string | See service validation | Value. |
