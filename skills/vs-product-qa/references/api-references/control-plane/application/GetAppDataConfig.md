...
- API name: `GetAppDataConfig`
- Category: Control Plane - Application
- Description: Gets App Data Config.

## IDL Definition

```proto
message GetApplicationDataConfigReq {
  string AppID = 1;
  string DatasetID = 2;
  int64 FieldsConfigVersion = 3;
  string ProjectName = 20;
}

message GetApplicationDataConfigResp {
  AppDataSetConfig Config = 1;
}
