...
- API name: `UpdateDataset`
- Category: Control Plane - Dataset
- Description: Updates Dataset.
...
message UpdateDatasetReq {
  ...
  int64 Version = 3;
  DataFieldConfig DataFieldConfig = 4;
  int64 FieldsConfigVersion = 5;
  string Description = 6;
  ProcessConfig ProcessConfig = 7;
