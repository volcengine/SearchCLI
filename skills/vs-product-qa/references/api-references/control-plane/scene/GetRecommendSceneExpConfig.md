# GetRecommendSceneExpConfig

## Overview

- API name: `GetRecommendSceneExpConfig`
- Category: Control Plane - Scene
- Description: Gets Recommend Scene Exp Config.
...
message GetRecommendSceneExpConfigResp {
  string SceneDynamic = 1;
}
...
This API returns an experiment/dynamic recommend-scene config representation. Request fields and `Config` follow the same constraints as `OnlineRecommendScene`.
